...
### Mount disks 
mount SATA SSD/NVMe SSD disks (Plotting SSDs) for plots temp files -> /mnt/plots-tmp
mount SATA HDD disks for plots (2 x WD Red Pro NAS HDD 16TB for ~ 200-300 k=32 plots) -> /mnt/plots
